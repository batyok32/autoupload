...
```
      ...
      --cache-dir string                     Directory rclone will use for caching. (default "/home/batyr/.cache/rclone")
      --checkers int                         Number of checkers to run in parallel. (default 8)
  -c, --checksum                             Skip based on checksum (if available) & size, not mod-time & size
      --client-cert string                   Client SSL certificate (PEM) for mutual TLS auth
      --client-key string                    Client SSL private key (PEM) for mutual TLS auth
      --compare-dest string                  use DIR to server side copy flies from.
      --config string                        Config file. (default "/home/batyr/.config/rclone/rclone.conf")
...
```
      ...
      --cache-chunk-path string                      Directory to cache chunk files. (default "/home/batyr/.cache/rclone/cache-backend")
      ...
      --cache-db-path string                         Directory to store file structure metadata DB. (default "/home/batyr/.cache/rclone/cache-backend")
  ...
  -L, --copy-links                                   Follow symlinks and copy the pointed to item.
      ...
      --ftp-user string                              FTP username, leave blank for current username, batyr
  ...
  -x, --one-file-system                              Don't cross filesystem boundaries (unix/macOS only).
      ...
      --sftp-user string                             SSH username, leave blank for current username, batyr
